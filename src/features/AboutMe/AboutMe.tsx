...
export default function AboutMe() {
  ...
  return (
    <section id="about" className="py-16 md:py-24 px-4 sm:px-6 lg:px-16 relative overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p variants={textVariants} className="text-base sm:text-lg text-foreground-muted leading-relaxed">
          ...
          >
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {stats.map((stat, index) => (
                <motion.div 
                  ...
                  className={`flat-card-interactive p-4 sm:p-6 flex flex-col justify-center items-center text-center ${index === 2 ? 'col-span-2' : ''}`}
                >
                  <span className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-foreground mb-1 tracking-tight font-serif">
                    {stat.number}
                  </span>
                  <span className="text-[11px] sm:text-xs font-semibold text-brand-primary uppercase tracking-wider">
                    {stat.label}
                  </span>
                </motion.div>
              ))}
            ...
            <motion.div 
              variants={statVariants}
              className="flat-card border-l-4 border-l-brand-primary p-4 sm:p-6"
            >
              <p className="text-base sm:text-lg md:text-xl font-medium italic text-foreground-muted text-center leading-snug font-serif">
